...
namespace 
{
    ...
    std::vector<rAI::mesh> make_cornell_box()
    {
        ...
        rAI::material white_material{ glm::vec3{ 1.f }, glm::vec3{ 0.0f }, 0.0f, 0.0f, glm::vec3{ 1.0f }, 0.0f };
        rAI::material red_material{ glm::vec3{ 0.9f, 0.1f, 0.1f }, glm::vec3{ 0.0f }, 0.0f, 0.0f, glm::vec3{ 1.0f }, 0.0f };
        rAI::material green_material{ glm::vec3{ 0.1f, 0.9f, 0.1f }, glm::vec3{ 0.0f }, 0.0f, 0.0f, glm::vec3{ 1.0f }, 0.0f };
    ...
    {
        rAI::material bed_material{ glm::vec3{ 1.f }, glm::vec3{ 0.0f }, 0.0f, 0.0f, glm::vec3{ 1.0f }, 0.0f };
    ...
    {
        rAI::material sphere_material_a{ glm::vec3{ 0.95f, 0.95f, 0.95f }, glm::vec3{ 0.0f }, 0.0f, 1.0f, glm::vec3{ 1.0f }, 0.2f };
        rAI::material sphere_material_b{ glm::vec3{ 0.8f, 0.2f, 0.2f }, glm::vec3{ 0.0f }, 0.0f, 0.0f, glm::vec3{ 1.0f }, 0.0f };
        rAI::material sphere_material_c{ glm::vec3{ 0.2f, 0.6f, 0.9f }, glm::vec3{ 0.0f }, 0.0f, 0.2f, glm::vec3{ 1.0f }, 0.2f };

        std::vector<rAI::sphere> spheres;

        spheres.push_back(rAI::sphere{ glm::vec3{0.0f, 1.0f, 0.0f}, 0.5f, sphere_material_a });
        spheres.push_back(rAI::sphere{ glm::vec3{-1.2f, 1.0f, 0.0f}, 0.5f, sphere_material_b });
        spheres.push_back(rAI::sphere{ glm::vec3{1.2f, 1.0f, 0.0f}, 0.5f, sphere_material_c });
...
namespace app
{
    void application::run()
    {
        ...
        render_settings_data.rays_per_pixel = 10;
        ...
        render_settings_data.sky_box.zenith_color = glm::vec3(0.1f, 0.2f, 0.8f),
        render_settings_data.sky_box.ground_color = glm::vec3(0.9f, 0.9f, 0.9f);

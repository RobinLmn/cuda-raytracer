...
namespace app
{
    render_settings::render_settings(render_settings_data& settings, const std::function<void()>& on_save_image_delegate, const std::function<void()>& on_render_stop_delegate)
        : settings{ settings }
        , on_save_image_delegate{ on_save_image_delegate }
        , on_render_stop_delegate{ on_render_stop_delegate }
    {
    }
    ...
    void render_settings::draw()
    {
        ...
        static constexpr float button_width = 60.f;
